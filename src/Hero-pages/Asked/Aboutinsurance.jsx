...
//                                     >
//                                         <div style={{ display: 'flex', justifyContent: 'space-between', width: '100%' }}>
//                                             <div>Can I use my Safepoints for any insurance at Getsafe?</div>
//                                             <div> 
//                                                 <i
...
//                                     >
//                                         <div style={{ display: 'flex', justifyContent: 'space-between', width: '100%' }}>
//                                             <div>How does Getsafe's pricing compare to other providers?</div>
//                                             <div>
//                                                 <i
    ...
    return (
        <>
            <div className="container mt-3 askmt">
                <div className="row">
                    <div className="col-sm-12 text-center">
                        <h1 className='xyza'  style={{ fontSize: '36px', fontWeight: '700' }}>Frequently Asked Questions</h1>
                        <p style={{ fontSize: '36px', fontWeight: '400' }}>About Insurance</p>
                        <p style={{ fontSize: '16px', fontWeight: '400' }}>Know why did they choose</p>
                    </div>
