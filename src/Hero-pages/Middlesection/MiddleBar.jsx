            ...
            <div className="container p-0">
                <div className='Middle-flex'>
                    ...
                    <div className='middle-box'>
                        ...
                        <div className='md-l-img'>
                            <img src="https://i.ibb.co/KNnK06R/6f1ed349-d120-4ce4-8115-51a9501bb527.jpg" alt="" />
                            <a className='m-m-a-c' href="">Get Insured</a>
                        </div>
                    </div>
                    <div className='middle-box'>
                        ...
                        <div className='md-l-img'>
                            <img src="https://i.ibb.co/n1Ggm4K/80feb22b-99e9-421d-954b-88c32e3ecaab.jpg" alt="" />
                            <a className='m-m-a-c' href="">Get Insured</a>
                        </div>
                    </div>
                    <div className='middle-box'>
                        ...
                        <div className='md-l-img'>
                            <img src="https://i.ibb.co/ZNBcVDd/5869438e-610e-4d6c-9b67-2eef2b6e00b9.jpg" alt="" />
                            <a className='m-m-a-c' href="">Get Insured</a>
                        </div>
                    </div>
                </div>
