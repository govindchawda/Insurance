                        ...
                        <div className="col-md-6">
                            <div className="travel-home-card p-5">
                                <p className="travel-home-card-title">
                                    ...
                                    <span className="travel-home-price">AED 33*</span>
                                </p>
                                <Link to="/treveltreePage2" style={{width:'100%'}} className="btn travel-tyep2">Travling to UAE</Link>
                                <Link to="/treveltreePage2" style={{width:'100%'}} className="btn travel-tyep2 mt-3">Travling out of UAE</Link>
                                <button className="btn travel-home-button w-100 ">Buy Now</button>
                            </div>
                        </div>
                    </div>
