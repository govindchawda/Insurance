                        ...
                        <div className="insurance_section d-flex align-items-center justify-content-center">
                            ...
                            <div className="insurance_buttons">
                                ...
                                <div className="mt-3 ">
                                    ...
                                    <Link to='/stepppperform' className="btn btn_option proceed_btn ">Proceed</Link>
            ...
            <div className="container p-1 bodycount shadow mt-3">
                <div className="row">
                    ...
                    <div className="col-md-2">
                        <div className="card txtbody">
                            <div className="card-body">
                                <div className="stats-value">21+</div>
                    ...
                    <div className="col-md-2">
                        <div className="card txtbody">
                            <div className="card-body">
                                <div className="stats-value">250K+</div>
                ...
                <div className="container mt-5">
                    <div className="row">
                        ...
                        <div className="col-md-3 mt-5">
                            <div className="">
                                <p style={{ fontSize: '18px' }}>Why choose Policybazaar to  buy insurance? </p>
